    ...
    ##    MODEL_NAME='keras_model.h5'
        ...
        for num, data in enumerate(verify_data):
            ...
            if np.argmax(model_out) == 0:
                str_label = 'benign'
                print("The predicted image of the benign is with a accuracy of {} %".format(model_out[0]*100))
                accuracy = "The predicted image of the benign is with a accuracy of {} %".format(model_out[0]*100)
                Tre = "The Treatment for benign are:\n\n "
                Tre1 = [" Cryotherapy",  
                ...
                Tre = "The Treatment for malignant are:\n\n "
